...
public class CertificatRecyclageController {
    ...
    @GetMapping("/byDemande/{demandeId}")
    public CertificatRecyclage getByDemande(@PathVariable int demandeId) {
        return certificatRecyclageService.findByDemandeId(demandeId);
    }
}
