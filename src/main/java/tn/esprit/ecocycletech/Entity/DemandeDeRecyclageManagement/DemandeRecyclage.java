...
public class DemandeRecyclage  {
    ...
    public void setNbrAppareils(int nbrAppareils) {
    ...
    public void setCertificatRecyclage(CertificatRecyclage certificatRecyclage) {
    ...
    @OneToOne(mappedBy = "demandeRecyclage", cascade = CascadeType.ALL, orphanRemoval = true)
    ...
    @OneToMany(mappedBy = "demandeRecyclage", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @JsonManagedReference
    private List<CommentaireDemande> commentaires;
